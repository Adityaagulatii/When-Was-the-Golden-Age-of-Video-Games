...
<p>In this project, we'll explore the top 400 best-selling video games created between 1977 and 2020. We'll compare a dataset on game sales with critics and user reviews to determine whether or not video games have improved as the gaming market has grown.</p>
...
Data Manipulation and Analysis of the project were done with the help of SQL. 
Please find the [detailed analysis here](Analysis.pdf)

## Conclusion
In conclusion, the old age of video games can be determined between the late 1990s and mid-2000s in terms of sales. Most likely, video games became an expensive medium so the sales went down.

## Limitations
The dataset does not contain sufficient to confirm our conclusions. 
